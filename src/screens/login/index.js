...
class LoginScreen extends Component {
    ...
    render() {
        const { selectedDate, selectedMonth, selectedYear, rememberMe } = this.state;
        let dateArr = [];
                ...
                <Content contentContainerStyle={globalStyles.contentContainer}>
                    <View style={styles.contentContainer}>
                        ...
                        <View style={styles.footerContainer}>
                            <TouchableOpacity onPress={() => this.setState({ rememberMe: !this.state.rememberMe })} style={styles.rememberMeContainer}>
                                <Icon name={rememberMe ? 'checkbox-marked' : 'checkbox-blank-outline'} type='MaterialCommunityIcons' style={[styles.rememberMeIcon]} />
                                <Text style={styles.rememberMeText}>Recordar contrasena</Text>
                            </TouchableOpacity>
                        </View>
                        <View style={styles.content}>
                        ...
                        <View style={styles.footerContainer}>
                            <TouchableOpacity onPress={() => this.props.navigation.navigate('Signup')}>
                                <Text style={styles.footerText}>No tengo una cuenta</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </Content>
