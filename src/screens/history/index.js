        ...
        return (
            <Container style={globalStyles.tabContainer}>
                ...
                <View style={styles.filterContainer}>
                    <View style={styles.container}>
                        <Text style={styles.filterTitle}>Diagnosticos</Text>
                    </View>
                    <TouchableOpacity style={styles.filterContent}>
                        <Text style={styles.filterSubTitle}>Alergias</Text>
                        <Icon name='chevron-down' type='MaterialCommunityIcons' style={styles.filterIcon} />
                    </TouchableOpacity>
                </View>
                <Content>
